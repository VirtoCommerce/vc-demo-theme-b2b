productCompareListController.$inject = ['compareProductService', 'catalogService', '$scope', '$rootScope', '$location', 'baseUrl'];
function productCompareListController(compareProductService, catalogService, $scope, $rootScope, $location, baseUrl) {
  var $ctrl = this;
