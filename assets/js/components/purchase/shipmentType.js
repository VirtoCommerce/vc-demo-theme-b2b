vcShipmentTypeController.$inject = ['$scope', '$localStorage', 'storefrontApp.mainContext', 'dialogService'];
function vcShipmentTypeController($scope, $localStorage, mainContext, dialogService) {
    var $ctrl = this;
    $ctrl.ctrl = $ctrl;
...
storefrontApp.component('vcShipmentType', {
  ...
  transclude: true,
  controllerAs: '$ctrl',
  controller: vcShipmentTypeController
});

storefrontApp.component('vcShipmentTypeMigration', {
  templateUrl: "themes/assets/js/bootstrap-migration/components/purchase/shipmentType.tpl.html",
  bindings: {
    ctrl: '=',
    shipmentType: '<',
    shipmentAddress: '<',
