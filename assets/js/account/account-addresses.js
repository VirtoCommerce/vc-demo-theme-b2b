...
.component('vcAccountAddresses', {
    templateUrl: [ '$rootScope', function($rootScope) {
        return $rootScope.adjustTemplateUrl("themes/assets/js/account/account-addresses.tpl");
    }],
    require: {
        ...
        $ctrl.updateCustomer = function (customer, handler) {
            return loader.wrapLoading(function () {
                ...
                return accountApi.updateUser(customer).then(function () {
                    return mainContext.loadCustomer().then(function (loadedCustomer) {
                        $ctrl.currentMember = loadedCustomer;
                        if (handler) {
                            handler();
                        }
                    });
